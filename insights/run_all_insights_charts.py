...
Executa sequencialmente cada gerador de módulo em insights/ organizado por categorias:
- 01_descriptive/ (Descritivos: BI de Recuperação, Motivos de Abandono, Custo por Recuperação & ROI)
- 02_risk/ (Diagnóstico de Risco: Segmentação RFM, LTV vs Abandono, Viabilidade Econômica)
- 03_prescriptive/ (Prescritivos: Estratégia de Resgate por Canal, Otimização de Timing, Produtos Críticos, ROI Campanhas)
- 04_intelligence_ai/ (Inteligência & IA: Modelos Preditivos, GenAI Copies, Similaridade, Data App ROI)
"""
...
SCRIPTS: Final[List[str]] = [
    ...
    # 04_intelligence_ai
    os.path.join("04_intelligence_ai", "generate_chart.py"),
    os.path.join("04_intelligence_ai", "01_modelos_preditivos_ml", "generate_chart.py"),
    os.path.join("04_intelligence_ai", "02_genai_extracao_copies", "generate_chart.py"),
    os.path.join("04_intelligence_ai", "03_similaridade_produtos", "generate_chart.py"),
    os.path.join("04_intelligence_ai", "04_data_app_simulador_roi", "generate_chart.py")
]

def main() -> None:
    print("=" * 80)
    print(" INICIANDO GERAÇÃO DE GRÁFICOS DE INSIGHTS CATEGORIZADOS (INSIGHTS/ CANÔNICO)")
    print("=" * 80)
