...
### 4. 🧠 Insights de Inteligência, GenAI & Data Apps (`04_intelligence_ai/`)

| # | Módulo | Status | Tema & Descrição | Tipo de Visualização | Artefatos na Pasta |
|:---:|---|:---:|---|---|---|
| **Master** | [`04_intelligence_ai/`](04_intelligence_ai/) | ✅ Concluído | **Módulo de Inteligência & IA Master**: Painel consolidado demonstrando a evolução de maturidade de IA (Antes vs Agora) e a Tríade de Inteligência (Stepsfera ML, GenAI Pydantic e Streamlit Data Apps). | Painel Executivo Master 16:9 | [`spec.md`](04_intelligence_ai/spec.md) • [`generate_chart.py`](04_intelligence_ai/generate_chart.py) • [`chart_insights_ia_master.png`](04_intelligence_ai/chart_insights_ia_master.png) |
| **01** | [`01_modelos_preditivos_ml/`](04_intelligence_ai/01_modelos_preditivos_ml/) | ✅ Concluído | **Modelos Preditivos de Negócio (Item 8)**: Curva ROC (AUC: 0.9478), Acurácia 99.53% e Feature Importance de propensão de resgate. | Curva ROC + Scorecard de Classificação + Barras de Feature Importance | [`spec.md`](04_intelligence_ai/01_modelos_preditivos_ml/spec.md) • [`generate_chart.py`](04_intelligence_ai/01_modelos_preditivos_ml/generate_chart.py) • [`chart_modelos_preditivos_ml.png`](04_intelligence_ai/01_modelos_preditivos_ml/chart_modelos_preditivos_ml.png) |
| **02** | [`02_genai_extracao_copies/`](04_intelligence_ai/02_genai_extracao_copies/) | ✅ Concluído | **GenAI & Processamento Desestruturado (Item 5)**: 100% Pydantic JSON Schema, extração de atributos de catálogo e +18% de CTR. | Diagrama de Pipeline Pydantic + Barras Agrupadas de CTR + Cards de Mensagens | [`spec.md`](04_intelligence_ai/02_genai_extracao_copies/spec.md) • [`generate_chart.py`](04_intelligence_ai/02_genai_extracao_copies/generate_chart.py) • [`chart_genai_extracao_copies.png`](04_intelligence_ai/02_genai_extracao_copies/chart_genai_extracao_copies.png) |
| **03** | [`03_similaridade_produtos/`](04_intelligence_ai/03_similaridade_produtos/) | ✅ Concluído | **Busca Semântica & Embeddings (Item 9 & Bônus)**: Projeção vetorial 2D (t-SNE/PCA) e motor de Similaridade de Cosseno (+12.4% conversão cruzada). | Scatter Plot 2D de Embeddings + Motor de Cosseno + Vitrine Prescritiva | [`spec.md`](04_intelligence_ai/03_similaridade_produtos/spec.md) • [`generate_chart.py`](04_intelligence_ai/03_similaridade_produtos/generate_chart.py) • [`chart_similaridade_produtos.png`](04_intelligence_ai/03_similaridade_produtos/chart_similaridade_produtos.png) |
| **04** | [`04_data_app_simulador_roi/`](04_intelligence_ai/04_data_app_simulador_roi/) | ✅ Concluído | **Data Apps em Streamlit & ROI (Item 9)**: Simulador interativo de sensibilidade de ROI (45x) e gráfico waterfall de +R$ 167,9k de ganho líquido. | Curva de Sensibilidade Financeira + Gráfico Waterfall Contábil | [`spec.md`](04_intelligence_ai/04_data_app_simulador_roi/spec.md) • [`generate_chart.py`](04_intelligence_ai/04_data_app_simulador_roi/generate_chart.py) • [`chart_data_app_simulador_roi.png`](04_intelligence_ai/04_data_app_simulador_roi/chart_data_app_simulador_roi.png) |
