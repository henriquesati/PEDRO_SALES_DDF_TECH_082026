...
"""
generate_chart.py
Módulo: insights/03_prescriptive/03_produtos_mais_abandonados (Ato 3 / Seção [4.2] - Atrito por Catálogo & Intervenções Prescritivas)
...
PARQUET_ITEMS_PATH: Final[Path] = (
    ...
    else (BASE_DIR / "data" / "mock" / "output_cleaned" / "parquet" / "itens_carrinho.parquet" if (BASE_DIR / "data" / "mock" / "output_cleaned" / "parquet" / "itens_carrinho.parquet").exists() else BASE_DIR / "data" / "mock" / "output" / "parquet" / "itens_carrinho.parquet")
)
...
PARQUET_PRODS_PATH: Final[Path] = (
    ...
    else (BASE_DIR / "data" / "mock" / "output_cleaned" / "parquet" / "produtos.parquet" if (BASE_DIR / "data" / "mock" / "output_cleaned" / "parquet" / "produtos.parquet").exists() else BASE_DIR / "data" / "mock" / "output" / "parquet" / "produtos.parquet")
)
