...
View do Roteiro: case-carrinho/views/insights/timingenvio/
...
def generate_standalone_card(output_path: str) -> None:
...
def main() -> None:
    ...
    card_path = os.path.join(os.path.dirname(OUTPUT_IMAGE_PATH), "card_destaque_timing_executivo.png")
