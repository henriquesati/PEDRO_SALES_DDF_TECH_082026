...
Módulo: views-04-insights/prescritivos/roicampanhas
...
CANONICAL_SCRIPT_PATH = BASE_DIR / "insights" / "03_prescriptive/04_roi_campanhas_resgate/generate_chart.py"

def load_canonical_module():
    spec = importlib.util.spec_from_file_location("canonical_roi_campanhas", CANONICAL_SCRIPT_PATH)
...
def main() -> None:
    ...
    print("[WRAPPER] Acionando o gerador canônico: insights/03_prescriptive/04_roi_campanhas_resgate/generate_chart.py...")
