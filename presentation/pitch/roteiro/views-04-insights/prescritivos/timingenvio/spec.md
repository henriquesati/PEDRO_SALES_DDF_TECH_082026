...
> **Caminho da View**: `presentation/pitch/roteiro/views-04-insights/prescritivos/timingenvio/`  
> **Momento do Roteiro**: **Ato 3 / Seção [4.2] — Otimização de Timing & Cadência de Disparos**  
...
2. **Concentração na Janela de +1h**: A primeira régua de contato disparada em até **1 hora pós-abandono concentra 86,4% de todas as conversões observadas** (38 de 44 resgates).
...
## 📊 2. Métricas & Fórmulas (Ground Truth)
...
## 🎨 3. Especificações do Painel Visual
...
| [`card_destaque_timing_executivo.png`](card_destaque_timing_executivo.png) | Card executivo individual com destaques do timing. |
