...
Módulo: views-04-insights/prescritivos/timingenvio
...
CANONICAL_SCRIPT_PATH = BASE_DIR / "insights" / "03_prescriptive/02_otimizacao_timing_envio/generate_chart.py"

def load_canonical_module():
    spec = importlib.util.spec_from_file_location("canonical_timing_envio", CANONICAL_SCRIPT_PATH)
...
def main() -> None:
    ...
    print("[WRAPPER] Acionando o gerador canônico: insights/03_prescriptive/02_otimizacao_timing_envio/generate_chart.py...")
