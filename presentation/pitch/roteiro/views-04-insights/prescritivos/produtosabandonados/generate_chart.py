...
Módulo: views-04-insights/prescritivos/produtosabandonados
...
CANONICAL_SCRIPT_PATH = BASE_DIR / "insights" / "03_prescriptive/03_produtos_mais_abandonados/generate_chart.py"

def load_canonical_module():
    spec = importlib.util.spec_from_file_location("canonical_produtos_abandonados", CANONICAL_SCRIPT_PATH)
...
def main() -> None:
    ...
    print("[WRAPPER] Acionando o gerador canônico: insights/03_prescriptive/03_produtos_mais_abandonados/generate_chart.py...")
