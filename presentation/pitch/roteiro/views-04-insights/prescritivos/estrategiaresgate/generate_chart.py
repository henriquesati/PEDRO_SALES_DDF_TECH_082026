...
Módulo: views-04-insights/prescritivos/estrategiaresgate
...
CANONICAL_SCRIPT_PATH = BASE_DIR / "insights" / "03_prescriptive/01_estrategia_resgate_segmento/generate_chart.py"

def load_canonical_module():
    spec = importlib.util.spec_from_file_location("canonical_estrategia_resgate", CANONICAL_SCRIPT_PATH)
...
def main() -> None:
    ...
    print("[WRAPPER] Acionando o gerador canônico: insights/03_prescriptive/01_estrategia_resgate_segmento/generate_chart.py...")
