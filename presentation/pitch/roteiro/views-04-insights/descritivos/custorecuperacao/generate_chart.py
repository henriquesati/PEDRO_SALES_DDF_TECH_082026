...
Módulo: views-04-insights/descritivos/custorecuperacao
...
CANONICAL_SCRIPT_PATH = BASE_DIR / "insights" / "01_descriptive/03_custo_recuperacao_roi/generate_chart.py"

def load_canonical_module():
    spec = importlib.util.spec_from_file_location("canonical_custo_recuperacao", CANONICAL_SCRIPT_PATH)
...
def main() -> None:
    ...
    print("[WRAPPER] Acionando o gerador canônico: insights/01_descriptive/03_custo_recuperacao_roi/generate_chart.py...")
