...
Módulo: views-04-insights/descritivos/funilrecuperacao
...
CANONICAL_SCRIPT_PATH = BASE_DIR / "insights" / "01_descriptive/01_bi_recuperacao_carrinhos/generate_chart.py"

def load_canonical_module():
    spec = importlib.util.spec_from_file_location("canonical_funil_recuperacao", CANONICAL_SCRIPT_PATH)
...
def main() -> None:
    ...
    print("[WRAPPER] Acionando o gerador canônico: insights/01_descriptive/01_bi_recuperacao_carrinhos/generate_chart.py...")
