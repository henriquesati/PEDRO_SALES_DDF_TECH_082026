...
Módulo: views-05-insights-ia/data-app-simulador-roi
...
CANONICAL_SCRIPT_PATH = BASE_DIR / "insights" / "04_intelligence_ai/04_data_app_simulador_roi/generate_chart.py"

def load_canonical_module():
    spec = importlib.util.spec_from_file_location("canonical_simulador_roi", CANONICAL_SCRIPT_PATH)
...
def main() -> None:
    ...
    print("[WRAPPER] Acionando o gerador canônico: insights/04_intelligence_ai/04_data_app_simulador_roi/generate_chart.py...")
