...
Módulo: views-05-insights-ia/modelos-preditivos-ml
...
CANONICAL_SCRIPT_PATH = BASE_DIR / "insights" / "04_intelligence_ai/01_modelos_preditivos_ml/generate_chart.py"

def load_canonical_module():
    spec = importlib.util.spec_from_file_location("canonical_modelos_preditivos", CANONICAL_SCRIPT_PATH)
...
def main() -> None:
    ...
    print("[WRAPPER] Acionando o gerador canônico: insights/04_intelligence_ai/01_modelos_preditivos_ml/generate_chart.py...")
