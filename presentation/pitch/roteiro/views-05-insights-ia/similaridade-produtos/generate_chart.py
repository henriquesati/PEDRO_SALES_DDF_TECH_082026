...
Módulo: views-05-insights-ia/similaridade-produtos
...
CANONICAL_SCRIPT_PATH = BASE_DIR / "insights" / "04_intelligence_ai/03_similaridade_produtos/generate_chart.py"

def load_canonical_module():
    spec = importlib.util.spec_from_file_location("canonical_similaridade_produtos", CANONICAL_SCRIPT_PATH)
...
def main() -> None:
    ...
    print("[WRAPPER] Acionando o gerador canônico: insights/04_intelligence_ai/03_similaridade_produtos/generate_chart.py...")
