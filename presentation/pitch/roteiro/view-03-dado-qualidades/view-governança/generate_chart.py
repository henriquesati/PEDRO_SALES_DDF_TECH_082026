...
"""
generate_chart.py
Módulo: view-governança (Roteiro Seção {3.1} - Governança, Dicionário de Dados & LGPD)
...
COLORS: Final[Dict[str, str]] = {
    ...
    "text_dark": "#0F172A",
    "text_muted": "#475569",
    "amber": "#D97706",         # Governança / Alerta
    "shield_blue": "#2563EB",   # Segurança / LGPD
    "accent_green": "#10B981",  # Sucesso / Opt-in Ativo
    "pii_coral": "#EF4444",     # Dado Sensível / PII Protegido
    "grid": "#E2E8F0"
}
...
def render_placeholder(ax: plt.Axes) -> None:
    ...
    ax.text(
        0.5, 0.5,
        "ESTRUTURA BASE CRIADA: view-governança\n(Aguardando Implementação Visual do Painel de Governança, Dicionário & LGPD)",
        ha="center", va="center",
