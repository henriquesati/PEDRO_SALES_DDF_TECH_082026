...
| [`views-streamlit/`](file:///c:/Users/pedro/OneDrive/Desktop/wheels/presentation/pitch/roteiro/views-streamlit/) | **Ato 4 / Seção [5.4]: Consumo & Telas Executivas do Data App Streamlit** | Envelopamento de 4 Telas Modulares + Overview | • `chart_streamlit_data_app_overview.png`<br/>• `chart_streamlit_simulador_roi.png`<br/>• `chart_streamlit_explorador_catalogo.png`<br/>• `chart_streamlit_copiloto_resgate.png`<br/>• `chart_streamlit_vitrine_produtos.png` |
