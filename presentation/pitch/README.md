...
## 🧭 Documentos Principais de Roteiro & Estrutura
...
- 📝 **[`roteiro.txt`](roteiro.txt)**: **Roteiro Falado, Notas de Apresentação e Comparativo de Infraestrutura (AWS vs Dadosfera)**
  - Tópicos cronológicos de fala para o vídeo/apresentação.
  - Decomposição detalhada dos gargalos da stack tradicional (Glue, Redshift, MWAA Airflow, Docker/ECR, IAM, Lake Formation, Alertas/CloudWatch) contra as soluções integradas da Dadosfera.
...
## 🎬 Arquitetura de Views do Roteiro (`presentation/pitch/roteiro/`)

O diretório [`presentation/pitch/roteiro/`](roteiro/) organiza as visões e mockups associados cronologicamente aos momentos de fala do `roteiro.txt`:
* **Ato 1 (Arquitetura Legada vs Dadosfera)**: [`roteiro/arquitetura-view/`](roteiro/arquitetura-view/) (Diagramas L2R e apresentação PPTX).
* **Momento 3 (Elasticidade)**: [`roteiro/problema-elasticidade/`](roteiro/problema-elasticidade/) (Gráfico de Risco em Picos de Black Friday).
* **Momento 4 (Staff Pain Point)**: [`roteiro/staff-pain-point/`](roteiro/staff-pain-point/) (Gráficos de Headcount e TCO Crossover).
* **Ato 3 (Blueprint Case Carrinho)**: [`roteiro/case-carrinho/views/`](roteiro/case-carrinho/views/)
  * *Timing de Envio*: [`roteiro/case-carrinho/views/insights/timingenvio/`](roteiro/case-carrinho/views/insights/timingenvio/) (Curva de Decaimento e Janela +1h).
