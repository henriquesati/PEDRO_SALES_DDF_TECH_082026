...
| **02** | [`02_motivos_abandono/`](02_motivos_abandono/) | ✅ Concluído | **Decomposição Descritiva de Motivos de Abandono**: Treemap hierárquico proporcional ao volume de atrito por causa-raiz (5.231 un) e gráfico separado de perda financeira represada (R$ 1.845,0k). | [1] Treemap Hierárquico de Blocos Proporcionais<br>[2] Barras Horizontais de Perda Financeira Represada | [`spec.md`](02_motivos_abandono/spec.md) • [`generate_chart.py`](02_motivos_abandono/generate_chart.py) • [`chart_02_treemap_motivos_abandono.png`](02_motivos_abandono/chart_02_treemap_motivos_abandono.png) • [`chart_02_perda_financeira_motivos.png`](02_motivos_abandono/chart_02_perda_financeira_motivos.png) |
