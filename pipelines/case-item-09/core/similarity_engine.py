"""Motor funcional de busca semântica, cálculo de similaridade e projeção t-SNE/PCA (Item 9).

Permite calcular similaridade por cosseno entre produtos a partir de features
estruturadas e gerar mapas de dispersão 2D interativos para o Streamlit.
"""
...
from core.types import ProductSimilarityMatch
