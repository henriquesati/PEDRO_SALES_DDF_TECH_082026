"""Motor declarativo de prompts e gerador de copies e vitrines GenAI (Item 9 & Bônus)."""
...
# Catálogo declarativo de gatilhos mentais por motivo de abandono
...
def generate_showcase_presentation(
    ...
    """Gera o script estruturado da apresentação visual do produto (Item Bônus)."""
    return {
