...
Gera os outputs (relatório markdown, gráficos e logs JSON) dentro de notebooks/pipelines/quality_report/outputs/
"""
...
# Diretórios de Output DENTRO de notebooks/pipelines/quality_report/
